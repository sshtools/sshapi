 ...
 * * They are called by the server module when events appear on the network.<br>
 ...
 */
public class ssh_bind_callbacks_struct extends Structure<ssh_bind_callbacks_struct, ssh_bind_callbacks_struct.ByValue, ssh_bind_callbacks_struct.ByReference > {
