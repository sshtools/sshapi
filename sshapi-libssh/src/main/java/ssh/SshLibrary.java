...
public interface SshLibrary extends Library {
	public static final String JNA_LIBRARY_NAME = LibraryExtractor
			.getLibraryPath(System.getProperty("net.sf.sshapi.libssh.libname", "ssh"), true, ssh.SshLibrary.class);
	public static final NativeLibrary JNA_NATIVE_LIB = NativeLibrary.getInstance(ssh.SshLibrary.JNA_LIBRARY_NAME,
			toStringKeyedMap(com.ochafik.lang.jnaerator.runtime.MangledFunctionMapper.DEFAULT_OPTIONS));
	public static final SshLibrary INSTANCE = (SshLibrary) Native.loadLibrary(ssh.SshLibrary.JNA_LIBRARY_NAME, ssh.SshLibrary.class,
			toStringKeyedMap(com.ochafik.lang.jnaerator.runtime.MangledFunctionMapper.DEFAULT_OPTIONS));

	static Map<String, ?> toStringKeyedMap(Map<Object, Object> map) {
		Map<String, Object> m = new HashMap<>();
		for (Map.Entry<Object, Object> en : map.entrySet()) {
			m.put((String) en.getKey(), en.getValue());
		}
		return m;
	}
	 ...
	 * @param user user-supplied pointer sent along with all callback
	 *            messages<br>
	 * @returns number of bytes processed by the callee. The remaining bytes
	 *          will<br>
	 *          be sent in the next callback message, when more data is
	 *          available.<br>
	 *          <i>native declaration : /usr/include/libssh/callbacks.h</i>
	 */
	...
	/**
	 * @brief SSH log callback. All logging messages will go through this
	 *        callback<br>
	 * @param session Current session handler<br>
	 * @param priority Priority of the log, the smaller being the more
	 *            important<br>
	...
	/**
	 * @brief SSH global request callback. All global request will go through
	 *        this<br>
	 *        callback.<br>
	 * @param session Current session handler<br>
	 * @param message the actual message<br>
	 ...
	 * @param packet buffer containing the packet, excluding size, type and
	 *            padding fields<br>
	 ...
	 * @returns SSH_PACKET_NOT_USED Packet was not used or understood,
	 *          processing must continue<br>
	 *          <i>native declaration : /usr/include/libssh/callbacks.h</i>
	 */
	...
	/**
	 * @brief SSH channel data callback. Called when data is available on a
	 *        channel<br>
	 * @param session Current session handler<br>
	...
	public interface ssh_channel_data_callback extends Callback {
		int apply(SshLibrary.ssh_session session, SshLibrary.ssh_channel channel, Pointer data, int len, int is_stderr,
				Pointer userdata);
	};
	...
	/**
	 * @brief SSH channel close callback. Called when a channel is closed by
	 *        remote peer<br>
	 * @param session Current session handler<br>
	 * @param channel the actual channel<br>
	 * @param userdata Userdata to be passed to the callback function.<br>
	...
	/**
	 * @brief SSH channel signal callback. Called when a channel has received a
	 *        signal<br>
	 * @param session Current session handler<br>
	 * @param channel the actual channel<br>
	...
	/**
	 * @brief SSH channel exit status callback. Called when a channel has
	 *        received an exit status<br>
	 * @param session Current session handler<br>
	 * @param channel the actual channel<br>
	 * @param userdata Userdata to be passed to the callback function.<br>
	 *            <i>native declaration : /usr/include/libssh/callbacks.h</i>
	...
	/**
	 * @brief SSH channel exit signal callback. Called when a channel has
	 *        received an exit signal<br>
	 * @param session Current session handler<br>
	 * @param channel the actual channel<br>
	 * @param signal the signal name (without the SIG prefix)<br>
	...
	public interface ssh_channel_exit_signal_callback extends Callback {
		void apply(SshLibrary.ssh_session session, SshLibrary.ssh_channel channel, Pointer signal, int core, Pointer errmsg,
				Pointer lang, Pointer userdata);
	};
	...
	/**
	 * @brief Incoming connection callback. This callback is called when a
	 *        ssh_bind<br>
	...
	/**
	 * Original signature :
	 * <code>int ssh_blocking_flush(ssh_session, int)</code><br>
	...
	/**
	 * Original signature :
	 * <code>ssh_channel ssh_channel_accept_x11(ssh_channel, int)</code><br>
	 * <i>native declaration : /usr/include/libssh/libssh.h:262</i>
	 */
	@Mangling({ "_Z22ssh_channel_accept_x11P18ssh_channel_structi",
			"?ssh_channel_accept_x11@@YAPA18ssh_channel_structPA18ssh_channel_structH@Z" })
	SshLibrary.ssh_channel ssh_channel_accept_x11(SshLibrary.ssh_channel channel, int timeout_ms);

	/**
	 * Original signature :
	 * <code>int ssh_channel_change_pty_size(ssh_channel, int, int)</code><br>
	 * <i>native declaration : /usr/include/libssh/libssh.h:263</i>
	 */
	@Mangling({ "_Z27ssh_channel_change_pty_sizeP18ssh_channel_structii",
			"?ssh_channel_change_pty_size@@YAHPA18ssh_channel_structHH@Z" })
	...
	/**
	 * Original signature :
	 * <code>int ssh_channel_get_exit_status(ssh_channel)</code><br>
	 * <i>native declaration : /usr/include/libssh/libssh.h:266</i>
	 */
	@Mangling({ "_Z27ssh_channel_get_exit_statusP18ssh_channel_struct",
			"?ssh_channel_get_exit_status@@YAHPA18ssh_channel_struct@Z" })
	int ssh_channel_get_exit_status(SshLibrary.ssh_channel channel);

	/**
	 * Original signature :
	 * <code>ssh_session ssh_channel_get_session(ssh_channel)</code><br>
	 * <i>native declaration : /usr/include/libssh/libssh.h:267</i>
	 */
	@Mangling({ "_Z23ssh_channel_get_sessionP18ssh_channel_struct",
			"?ssh_channel_get_session@@YAPA18ssh_session_structPA18ssh_channel_struct@Z" })
	SshLibrary.ssh_session ssh_channel_get_session(SshLibrary.ssh_channel channel);

	/**
	 * Original signature :
	 * <code>int ssh_channel_is_closed(ssh_channel)</code><br>
	...
	/**
	 * Original signature :
	 * <code>int ssh_channel_is_open(ssh_channel)</code><br>
	...
	/**
	 * Original signature :
	 * <code>ssh_channel ssh_channel_new(ssh_session)</code><br>
	...
	/**
	 * Original signature :
	 * <code>int ssh_channel_open_forward(ssh_channel, const char*, int, const char*, int)</code><br>
	 * <i>native declaration : /usr/include/libssh/libssh.h:272</i><br>
	 * 
	 * @deprecated use the safer methods
	 *             {@link #ssh_channel_open_forward(ssh.SshLibrary.ssh_channel, java.lang.String, int, java.lang.String, int)}
	 *             and
	 *             {@link #ssh_channel_open_forward(ssh.SshLibrary.ssh_channel, com.sun.jna.Pointer, int, com.sun.jna.Pointer, int)}
	 *             instead
	 */
	@Mangling({ "_Z24ssh_channel_open_forwardP18ssh_channel_structPKciPKci",
			"?ssh_channel_open_forward@@YAHPA18ssh_channel_structPADHPADH@Z" })
	@Deprecated
	int ssh_channel_open_forward(SshLibrary.ssh_channel channel, Pointer remotehost, int remoteport, Pointer sourcehost,
			int localport);
	...
	@Mangling({ "_Z24ssh_channel_open_forwardP18ssh_channel_structPKciPKci",
			"?ssh_channel_open_forward@@YAHPA18ssh_channel_structPADHPADH@Z" })
	int ssh_channel_open_forward(SshLibrary.ssh_channel channel, String remotehost, int remoteport, String sourcehost,
			int localport);

	/**
	 * Original signature :
	 * <code>int ssh_channel_open_session(ssh_channel)</code><br>
	...
	/**
	 * Original signature :
	 * <code>int ssh_channel_poll(ssh_channel, int)</code><br>
	...
	/**
	 * Original signature :
	 * <code>int ssh_channel_read(ssh_channel, void*, uint32_t, int)</code><br>
	 * <i>native declaration : /usr/include/libssh/libssh.h:276</i>
	 */
	@Mangling({ "_Z16ssh_channel_readP18ssh_channel_structPv8uint32_ti",
			"?ssh_channel_read@@YAHPA18ssh_channel_structPAX8uint32_tH@Z" })
	int ssh_channel_read(SshLibrary.ssh_channel channel, Pointer dest, int count, int is_stderr);

	/**
	 * Original signature :
	 * <code>int ssh_channel_read_nonblocking(ssh_channel, void*, uint32_t, int)</code><br>
	 * <i>native declaration : /usr/include/libssh/libssh.h:277</i>
	 */
	@Mangling({ "_Z28ssh_channel_read_nonblockingP18ssh_channel_structPv8uint32_ti",
			"?ssh_channel_read_nonblocking@@YAHPA18ssh_channel_structPAX8uint32_tH@Z" })
	int ssh_channel_read_nonblocking(SshLibrary.ssh_channel channel, Pointer dest, int count, int is_stderr);

	/**
	 * Original signature :
	 * <code>int ssh_channel_request_env(ssh_channel, const char*, const char*)</code><br>
	 * <i>native declaration : /usr/include/libssh/libssh.h:279</i><br>
	 * 
	 * @deprecated use the safer methods
	 *             {@link #ssh_channel_request_env(ssh.SshLibrary.ssh_channel, java.lang.String, java.lang.String)}
	 *             and
	 *             {@link #ssh_channel_request_env(ssh.SshLibrary.ssh_channel, com.sun.jna.Pointer, com.sun.jna.Pointer)}
	 *             instead
	 */
	@Mangling({ "_Z23ssh_channel_request_envP18ssh_channel_structPKcPKc",
			"?ssh_channel_request_env@@YAHPA18ssh_channel_structPADPAD@Z" })
	@Deprecated
	...
	/**
	 * Original signature :
	 * <code>int ssh_channel_request_exec(ssh_channel, const char*)</code><br>
	 * <i>native declaration : /usr/include/libssh/libssh.h:280</i><br>
	 * 
	 * @deprecated use the safer methods
	 *             {@link #ssh_channel_request_exec(ssh.SshLibrary.ssh_channel, java.lang.String)}
	 *             and
	 *             {@link #ssh_channel_request_exec(ssh.SshLibrary.ssh_channel, com.sun.jna.Pointer)}
	 *             instead
	 */
	@Mangling({ "_Z24ssh_channel_request_execP18ssh_channel_structPKc",
			"?ssh_channel_request_exec@@YAHPA18ssh_channel_structPAD@Z" })
	@Deprecated
	...
	/**
	 * Original signature :
	 * <code>int ssh_channel_request_pty(ssh_channel)</code><br>
	...
	/**
	 * Original signature :
	 * <code>int ssh_channel_request_pty_size(ssh_channel, const char*, int, int)</code><br>
	 * <i>native declaration : /usr/include/libssh/libssh.h:282</i><br>
	 * 
	 * @deprecated use the safer methods
	 *             {@link #ssh_channel_request_pty_size(ssh.SshLibrary.ssh_channel, java.lang.String, int, int)}
	 *             and
	 *             {@link #ssh_channel_request_pty_size(ssh.SshLibrary.ssh_channel, com.sun.jna.Pointer, int, int)}
	 *             instead
	 */
	@Mangling({ "_Z28ssh_channel_request_pty_sizeP18ssh_channel_structPKcii",
			"?ssh_channel_request_pty_size@@YAHPA18ssh_channel_structPADHH@Z" })
	@Deprecated
	...
	/**
	 * Original signature :
	 * <code>int ssh_channel_request_shell(ssh_channel)</code><br>
	...
	/**
	 * Original signature :
	 * <code>int ssh_channel_request_send_signal(ssh_channel, const char*)</code><br>
	 * <i>native declaration : /usr/include/libssh/libssh.h:285</i><br>
	 * 
	 * @deprecated use the safer methods
	 *             {@link #ssh_channel_request_send_signal(ssh.SshLibrary.ssh_channel, java.lang.String)}
	 *             and
	 *             {@link #ssh_channel_request_send_signal(ssh.SshLibrary.ssh_channel, com.sun.jna.Pointer)}
	 *             instead
	 */
	@Mangling({ "_Z31ssh_channel_request_send_signalP18ssh_channel_structPKc",
			"?ssh_channel_request_send_signal@@YAHPA18ssh_channel_structPAD@Z" })
	@Deprecated
	...
	/**
	 * Original signature :
	 * <code>int ssh_channel_request_sftp(ssh_channel)</code><br>
	...
	/**
	 * Original signature :
	 * <code>int ssh_channel_request_subsystem(ssh_channel, const char*)</code><br>
	 * <i>native declaration : /usr/include/libssh/libssh.h:287</i><br>
	 * 
	 * @deprecated use the safer methods
	 *             {@link #ssh_channel_request_subsystem(ssh.SshLibrary.ssh_channel, java.lang.String)}
	 *             and
	 *             {@link #ssh_channel_request_subsystem(ssh.SshLibrary.ssh_channel, com.sun.jna.Pointer)}
	 *             instead
	 */
	@Mangling({ "_Z29ssh_channel_request_subsystemP18ssh_channel_structPKc",
			"?ssh_channel_request_subsystem@@YAHPA18ssh_channel_structPAD@Z" })
	@Deprecated
	...
	/**
	 * Original signature :
	 * <code>int ssh_channel_request_x11(ssh_channel, int, const char*, const char*, int)</code><br>
	 * <i>native declaration : /usr/include/libssh/libssh.h:288</i><br>
	 * 
	 * @deprecated use the safer methods
	 *             {@link #ssh_channel_request_x11(ssh.SshLibrary.ssh_channel, int, java.lang.String, java.lang.String, int)}
	 *             and
	 *             {@link #ssh_channel_request_x11(ssh.SshLibrary.ssh_channel, int, com.sun.jna.Pointer, com.sun.jna.Pointer, int)}
	 *             instead
	 */
	@Mangling({ "_Z23ssh_channel_request_x11P18ssh_channel_structiPKcPKci",
			"?ssh_channel_request_x11@@YAHPA18ssh_channel_structHPADPADH@Z" })
	@Deprecated
	int ssh_channel_request_x11(SshLibrary.ssh_channel channel, int single_connection, Pointer protocol, Pointer cookie,
			int screen_number);
	...
	@Mangling({ "_Z23ssh_channel_request_x11P18ssh_channel_structiPKcPKci",
			"?ssh_channel_request_x11@@YAHPA18ssh_channel_structHPADPADH@Z" })
	int ssh_channel_request_x11(SshLibrary.ssh_channel channel, int single_connection, String protocol, String cookie,
			int screen_number);

	/**
	 * Original signature :
	 * <code>int ssh_channel_send_eof(ssh_channel)</code><br>
	...
	/**
	 * Original signature :
	 * <code>int ssh_channel_select(ssh_channel*, ssh_channel*, ssh_channel*, timeval*)</code><br>
	 * <i>native declaration : /usr/include/libssh/libssh.h:291</i>
	 */
	@Mangling({ "_Z18ssh_channel_selectPP18ssh_channel_structPP18ssh_channel_structPP18ssh_channel_structP7timeval",
			"?ssh_channel_select@@YAHPAPA18ssh_channel_structPAPA18ssh_channel_structPAPA18ssh_channel_structPA7timeval@Z" })
	int ssh_channel_select(PointerByReference readchans, PointerByReference writechans, PointerByReference exceptchans,
			Pointer timeout);

	/**
	 * Original signature :
	 * <code>void ssh_channel_set_blocking(ssh_channel, int)</code><br>
	...
	/**
	 * Original signature :
	 * <code>int ssh_channel_write(ssh_channel, const void*, uint32_t)</code><br>
	 * <i>native declaration : /usr/include/libssh/libssh.h:294</i>
	 */
	@Mangling({ "_Z17ssh_channel_writeP18ssh_channel_structPKv8uint32_t",
			"?ssh_channel_write@@YAHPA18ssh_channel_structPAX8uint32_t@Z" })
	int ssh_channel_write(SshLibrary.ssh_channel channel, Pointer data, int len);

	/**
	 * Original signature :
	 * <code>uint32_t ssh_channel_window_size(ssh_channel)</code><br>
	 * <i>native declaration : /usr/include/libssh/libssh.h:295</i>
	 */
	@Mangling({ "_Z23ssh_channel_window_sizeP18ssh_channel_struct",
			"?ssh_channel_window_size@@YA8uint32_tPA18ssh_channel_struct@Z" })
	int ssh_channel_window_size(SshLibrary.ssh_channel channel);

	/**
	 * Original signature :
	 * <code>int ssh_try_publickey_from_file(ssh_session, const char*, ssh_string*, int*)</code><br>
	 * <i>native declaration : /usr/include/libssh/libssh.h:297</i><br>
	 * 
	 * @deprecated use the safer methods
	 *             {@link #ssh_try_publickey_from_file(ssh.SshLibrary.ssh_session, java.lang.String, com.sun.jna.ptr.PointerByReference, java.nio.IntBuffer)}
	 *             and
	 *             {@link #ssh_try_publickey_from_file(ssh.SshLibrary.ssh_session, com.sun.jna.Pointer, com.sun.jna.ptr.PointerByReference, com.sun.jna.ptr.IntByReference)}
	 *             instead
	 */
	@Mangling({ "_Z27ssh_try_publickey_from_fileP18ssh_session_structPKcPP17ssh_string_structPi",
			"?ssh_try_publickey_from_file@@YAHPA18ssh_session_structPADPAPA17ssh_string_structPAH@Z" })
	@Deprecated
	int ssh_try_publickey_from_file(SshLibrary.ssh_session session, Pointer keyfile, PointerByReference publickey,
			IntByReference type);
	 ...
	 * 
	 * @deprecated use the safer methods {@link #ssh_basename(java.lang.String)}
	 *             and {@link #ssh_basename(com.sun.jna.Pointer)} instead
	 */
	...
	/**
	 * Original signature :
	 * <code>void ssh_clean_pubkey_hash(unsigned char**)</code><br>
	 ...
	 * 
	 * @deprecated use the safer methods {@link #ssh_dirname(java.lang.String)}
	 *             and {@link #ssh_dirname(com.sun.jna.Pointer)} instead
	 */
	...
	/**
	 * Original signature :
	 * <code>ssh_channel ssh_forward_accept(ssh_session, int)</code><br>
	 * <i>native declaration : /usr/include/libssh/libssh.h:308</i>
	 */
	@Mangling({ "_Z18ssh_forward_acceptP18ssh_session_structi",
			"?ssh_forward_accept@@YAPA18ssh_channel_structPA18ssh_session_structH@Z" })
	SshLibrary.ssh_channel ssh_forward_accept(SshLibrary.ssh_session session, int timeout_ms);

	/**
	 * Original signature :
	 * <code>int ssh_forward_cancel(ssh_session, const char*, int)</code><br>
	 * <i>native declaration : /usr/include/libssh/libssh.h:309</i><br>
	 * 
	 * @deprecated use the safer methods
	 *             {@link #ssh_forward_cancel(ssh.SshLibrary.ssh_session, java.lang.String, int)}
	 *             and
	 *             {@link #ssh_forward_cancel(ssh.SshLibrary.ssh_session, com.sun.jna.Pointer, int)}
	 *             instead
	 */
	...
	/**
	 * Original signature :
	 * <code>int ssh_forward_listen(ssh_session, const char*, int, int*)</code><br>
	 * <i>native declaration : /usr/include/libssh/libssh.h:310</i><br>
	 * 
	 * @deprecated use the safer methods
	 *             {@link #ssh_forward_listen(ssh.SshLibrary.ssh_session, java.lang.String, int, java.nio.IntBuffer)}
	 *             and
	 *             {@link #ssh_forward_listen(ssh.SshLibrary.ssh_session, com.sun.jna.Pointer, int, com.sun.jna.ptr.IntByReference)}
	 *             instead
	 */
	...
	/**
	 * Original signature :
	 * <code>char* ssh_get_disconnect_message(ssh_session)</code><br>
	 * <i>native declaration : /usr/include/libssh/libssh.h:312</i>
	 */
	@Mangling({ "_Z26ssh_get_disconnect_messageP18ssh_session_struct",
			"?ssh_get_disconnect_message@@YAQBDPA18ssh_session_struct@Z" })
	...
	/**
	 * Original signature :
	 * <code>char* ssh_get_hexa(const unsigned char*, size_t)</code><br>
	 * <i>native declaration : /usr/include/libssh/libssh.h:316</i><br>
	 * 
	 * @deprecated use the safer methods
	 *             {@link #ssh_get_hexa(byte[], com.ochafik.lang.jnaerator.runtime.NativeSize)}
	 *             and
	 *             {@link #ssh_get_hexa(com.sun.jna.Pointer, com.ochafik.lang.jnaerator.runtime.NativeSize)}
	 *             instead
	 */
	...
	/**
	 * Original signature :
	 * <code>char* ssh_get_issue_banner(ssh_session)</code><br>
	...
	/**
	 * Original signature :
	 * <code>int ssh_get_openssh_version(ssh_session)</code><br>
	...
	/**
	 * Original signature :
	 * <code>ssh_string ssh_get_pubkey(ssh_session)</code><br>
	...
	/**
	 * Original signature :
	 * <code>int ssh_get_pubkey_hash(ssh_session, unsigned char**)</code><br>
	...
	/**
	 * Original signature :
	 * <code>int ssh_is_server_known(ssh_session)</code><br>
	...
	/**
	 * Original signature :
	 * <code>void ssh_log(ssh_session, int, const char*, null)</code><br>
	 * <i>native declaration : /usr/include/libssh/libssh.h:328</i><br>
	 * 
	 * @deprecated use the safer methods
	 *             {@link #ssh_log(ssh.SshLibrary.ssh_session, int, java.lang.String, java.lang.Object)}
	 *             and
	 *             {@link #ssh_log(ssh.SshLibrary.ssh_session, int, com.sun.jna.Pointer, java.lang.Object)}
	 *             instead
	 */
	...
	/**
	 * Original signature :
	 * <code>ssh_channel ssh_message_channel_request_open_reply_accept(ssh_message)</code><br>
	 * <i>native declaration : /usr/include/libssh/libssh.h:329</i>
	 */
	@Mangling({ "_Z45ssh_message_channel_request_open_reply_acceptP18ssh_message_struct",
			"?ssh_message_channel_request_open_reply_accept@@YAPA18ssh_channel_structPA18ssh_message_struct@Z" })
	SshLibrary.ssh_channel ssh_message_channel_request_open_reply_accept(SshLibrary.ssh_message msg);

	/**
	 * Original signature :
	 * <code>int ssh_message_channel_request_reply_success(ssh_message)</code><br>
	...
	@Mangling({ "_Z41ssh_message_channel_request_reply_successP18ssh_message_struct",
			"?ssh_message_channel_request_reply_success@@YAHPA18ssh_message_struct@Z" })
	...
	/**
	 * Original signature :
	 * <code>ssh_message ssh_message_get(ssh_session)</code><br>
	...
	/**
	 * Original signature :
	 * <code>int ssh_message_subtype(ssh_message)</code><br>
	 ...
	 * 
	 * @deprecated use the safer methods
	 *             {@link #ssh_mkdir(java.lang.String, int)} and
	 *             {@link #ssh_mkdir(com.sun.jna.Pointer, int)} instead
	 */
	...
	/**
	 * Original signature :
	 * <code>int ssh_options_copy(ssh_session, ssh_session*)</code><br>
	 * <i>native declaration : /usr/include/libssh/libssh.h:338</i>
	 */
	@Mangling({ "_Z16ssh_options_copyP18ssh_session_structPP18ssh_session_struct",
			"?ssh_options_copy@@YAHPA18ssh_session_structPAPA18ssh_session_struct@Z" })
	int ssh_options_copy(SshLibrary.ssh_session src, PointerByReference dest);

	/**
	 * Original signature :
	 * <code>int ssh_options_getopt(ssh_session, int*, char**)</code><br>
	 * <i>native declaration : /usr/include/libssh/libssh.h:339</i><br>
	 * 
	 * @deprecated use the safer methods
	 *             {@link #ssh_options_getopt(ssh.SshLibrary.ssh_session, java.nio.IntBuffer, com.sun.jna.ptr.PointerByReference)}
	 *             and
	 *             {@link #ssh_options_getopt(ssh.SshLibrary.ssh_session, com.sun.jna.ptr.IntByReference, com.sun.jna.ptr.PointerByReference)}
	 *             instead
	 */
	...
	/**
	 * Original signature :
	 * <code>int ssh_options_parse_config(ssh_session, const char*)</code><br>
	 * <i>native declaration : /usr/include/libssh/libssh.h:340</i><br>
	 * 
	 * @deprecated use the safer methods
	 *             {@link #ssh_options_parse_config(ssh.SshLibrary.ssh_session, java.lang.String)}
	 *             and
	 *             {@link #ssh_options_parse_config(ssh.SshLibrary.ssh_session, com.sun.jna.Pointer)}
	 *             instead
	 */
	@Mangling({ "_Z24ssh_options_parse_configP18ssh_session_structPKc",
			"?ssh_options_parse_config@@YAHPA18ssh_session_structPAD@Z" })
	@Deprecated
	...
	/**
	 * Original signature :
	 * <code>int ssh_options_set(ssh_session, ssh_options_e, const void*)</code><br>
	 * <i>native declaration : /usr/include/libssh/libssh.h:341</i><br>
	 * 
	 * @param type @see ssh_options_e
	 */
	@Mangling({ "_Z15ssh_options_setP18ssh_session_struct13ssh_options_ePKv",
			"?ssh_options_set@@YAHPA18ssh_session_struct13ssh_options_ePAX@Z" })
	int ssh_options_set(SshLibrary.ssh_session session, int type, Pointer value);

	/**
	 * Original signature :
	 * <code>int ssh_pcap_file_close(ssh_pcap_file)</code><br>
	...
	/**
	 * Original signature :
	 * <code>void ssh_pcap_file_free(ssh_pcap_file)</code><br>
	...
	/**
	 * Original signature :
	 * <code>int ssh_pcap_file_open(ssh_pcap_file, const char*)</code><br>
	 * <i>native declaration : /usr/include/libssh/libssh.h:346</i><br>
	 * 
	 * @deprecated use the safer methods
	 *             {@link #ssh_pcap_file_open(ssh.SshLibrary.ssh_pcap_file, java.lang.String)}
	 *             and
	 *             {@link #ssh_pcap_file_open(ssh.SshLibrary.ssh_pcap_file, com.sun.jna.Pointer)}
	 *             instead
	 */
	...
	/**
	 * Original signature :
	 * <code>ssh_keytypes_e ssh_privatekey_type(ssh_private_key)</code><br>
	 * <i>native declaration : /usr/include/libssh/libssh.h:348</i>
	 */
	@Mangling({ "_Z19ssh_privatekey_typeP22ssh_private_key_struct",
			"?ssh_privatekey_type@@YA14ssh_keytypes_ePA22ssh_private_key_struct@Z" })
	/**
	 * @see ssh_keytypes_e
	 */
	...
	/**
	 * Original signature :
	 * <code>void ssh_print_hexa(const char*, const unsigned char*, size_t)</code><br>
	 * <i>native declaration : /usr/include/libssh/libssh.h:350</i><br>
	 * 
	 * @deprecated use the safer methods
	 *             {@link #ssh_print_hexa(java.lang.String, byte[], com.ochafik.lang.jnaerator.runtime.NativeSize)}
	 *             and
	 *             {@link #ssh_print_hexa(com.sun.jna.Pointer, com.sun.jna.Pointer, com.ochafik.lang.jnaerator.runtime.NativeSize)}
	 *             instead
	 */
	...
	/**
	 * Original signature :
	 * <code>int ssh_scp_deny_request(ssh_scp, const char*)</code><br>
	 * <i>native declaration : /usr/include/libssh/libssh.h:353</i><br>
	 * 
	 * @deprecated use the safer methods
	 *             {@link #ssh_scp_deny_request(ssh.SshLibrary.ssh_scp, java.lang.String)}
	 *             and
	 *             {@link #ssh_scp_deny_request(ssh.SshLibrary.ssh_scp, com.sun.jna.Pointer)}
	 *             instead
	 */
	...
	/**
	 * Original signature :
	 * <code>int ssh_scp_leave_directory(ssh_scp)</code><br>
	...
	/**
	 * Original signature :
	 * <code>ssh_scp ssh_scp_new(ssh_session, int, const char*)</code><br>
	 * <i>native declaration : /usr/include/libssh/libssh.h:357</i><br>
	 * 
	 * @deprecated use the safer methods
	 *             {@link #ssh_scp_new(ssh.SshLibrary.ssh_session, int, java.lang.String)}
	 *             and
	 *             {@link #ssh_scp_new(ssh.SshLibrary.ssh_session, int, com.sun.jna.Pointer)}
	 *             instead
	 */
	...
	/**
	 * Original signature :
	 * <code>int ssh_scp_push_directory(ssh_scp, const char*, int)</code><br>
	 * <i>native declaration : /usr/include/libssh/libssh.h:359</i><br>
	 * 
	 * @deprecated use the safer methods
	 *             {@link #ssh_scp_push_directory(ssh.SshLibrary.ssh_scp, java.lang.String, int)}
	 *             and
	 *             {@link #ssh_scp_push_directory(ssh.SshLibrary.ssh_scp, com.sun.jna.Pointer, int)}
	 *             instead
	 */
	...
	/**
	 * Original signature :
	 * <code>int ssh_scp_push_file(ssh_scp, const char*, size_t, int)</code><br>
	 * <i>native declaration : /usr/include/libssh/libssh.h:360</i><br>
	 * 
	 * @deprecated use the safer methods
	 *             {@link #ssh_scp_push_file(ssh.SshLibrary.ssh_scp, java.lang.String, com.ochafik.lang.jnaerator.runtime.NativeSize, int)}
	 *             and
	 *             {@link #ssh_scp_push_file(ssh.SshLibrary.ssh_scp, com.sun.jna.Pointer, com.ochafik.lang.jnaerator.runtime.NativeSize, int)}
	 *             instead
	 */
	...
	/**
	 * Original signature :
	 * <code>int ssh_scp_read(ssh_scp, void*, size_t)</code><br>
	...
	/**
	 * Original signature :
	 * <code>char* ssh_scp_request_get_filename(ssh_scp)</code><br>
	...
	/**
	 * Original signature :
	 * <code>int ssh_scp_request_get_permissions(ssh_scp)</code><br>
	 * <i>native declaration : /usr/include/libssh/libssh.h:363</i>
	 */
	@Mangling({ "_Z31ssh_scp_request_get_permissionsP14ssh_scp_struct",
			"?ssh_scp_request_get_permissions@@YAHPA14ssh_scp_struct@Z" })
	int ssh_scp_request_get_permissions(SshLibrary.ssh_scp scp);

	/**
	 * Original signature :
	 * <code>size_t ssh_scp_request_get_size(ssh_scp)</code><br>
	...
	/**
	 * Original signature :
	 * <code>char* ssh_scp_request_get_warning(ssh_scp)</code><br>
	...
	/**
	 * Original signature :
	 * <code>int ssh_scp_write(ssh_scp, const void*, size_t)</code><br>
	...
	/**
	 * Original signature :
	 * <code>int ssh_select(ssh_channel*, ssh_channel*, socket_t, fd_set*, timeval*)</code><br>
	 * <i>native declaration : /usr/include/libssh/libssh.h:367</i>
	 */
	@Mangling({ "_Z10ssh_selectPP18ssh_channel_structPP18ssh_channel_struct6SOCKETP6fd_setP7timeval",
			"?ssh_select@@YAHPAPA18ssh_channel_structPAPA18ssh_channel_struct6SOCKETPAUfd_set@@PA7timeval@Z" })
	int ssh_select(PointerByReference channels, PointerByReference outchannels, SshLibrary.SOCKET maxfd, Pointer readfds,
			Pointer timeout);

	/**
	 * Original signature :
	 * <code>int ssh_service_request(ssh_session, const char*)</code><br>
	 * <i>native declaration : /usr/include/libssh/libssh.h:369</i><br>
	 * 
	 * @deprecated use the safer methods
	 *             {@link #ssh_service_request(ssh.SshLibrary.ssh_session, java.lang.String)}
	 *             and
	 *             {@link #ssh_service_request(ssh.SshLibrary.ssh_session, com.sun.jna.Pointer)}
	 *             instead
	 */
	...
	/**
	 * Original signature :
	 * <code>void ssh_set_blocking(ssh_session, int)</code><br>
	...
	/**
	 * Original signature :
	 * <code>void ssh_set_fd_towrite(ssh_session)</code><br>
	...
	/**
	 * Original signature :
	 * <code>void ssh_silent_disconnect(ssh_session)</code><br>
	...
	/**
	 * Original signature :
	 * <code>int ssh_set_pcap_file(ssh_session, ssh_pcap_file)</code><br>
	 * <i>native declaration : /usr/include/libssh/libssh.h:375</i>
	 */
	@Mangling({ "_Z17ssh_set_pcap_fileP18ssh_session_structP20ssh_pcap_file_struct",
			"?ssh_set_pcap_file@@YAHPA18ssh_session_structPA20ssh_pcap_file_struct@Z" })
	int ssh_set_pcap_file(SshLibrary.ssh_session session, SshLibrary.ssh_pcap_file pcapfile);

	/**
	 * Original signature :
	 * <code>int ssh_userauth_autopubkey(ssh_session, const char*)</code><br>
	 * <i>native declaration : /usr/include/libssh/libssh.h:380</i><br>
	 * 
	 * @deprecated use the safer methods
	 *             {@link #ssh_userauth_autopubkey(ssh.SshLibrary.ssh_session, java.lang.String)}
	 *             and
	 *             {@link #ssh_userauth_autopubkey(ssh.SshLibrary.ssh_session, com.sun.jna.Pointer)}
	 *             instead
	 */
	...
	/**
	 * Original signature :
	 * <code>int ssh_userauth_kbdint(ssh_session, const char*, const char*)</code><br>
	 * <i>native declaration : /usr/include/libssh/libssh.h:381</i><br>
	 * 
	 * @deprecated use the safer methods
	 *             {@link #ssh_userauth_kbdint(ssh.SshLibrary.ssh_session, java.lang.String, java.lang.String)}
	 *             and
	 *             {@link #ssh_userauth_kbdint(ssh.SshLibrary.ssh_session, com.sun.jna.Pointer, com.sun.jna.Pointer)}
	 *             instead
	 */
	...
	/**
	 * Original signature :
	 * <code>char* ssh_userauth_kbdint_getinstruction(ssh_session)</code><br>
	 * <i>native declaration : /usr/include/libssh/libssh.h:382</i>
	 */
	@Mangling({ "_Z34ssh_userauth_kbdint_getinstructionP18ssh_session_struct",
			"?ssh_userauth_kbdint_getinstruction@@YAQBDPA18ssh_session_struct@Z" })
	String ssh_userauth_kbdint_getinstruction(SshLibrary.ssh_session session);

	/**
	 * Original signature :
	 * <code>char* ssh_userauth_kbdint_getname(ssh_session)</code><br>
	 * <i>native declaration : /usr/include/libssh/libssh.h:383</i>
	 */
	@Mangling({ "_Z27ssh_userauth_kbdint_getnameP18ssh_session_struct",
			"?ssh_userauth_kbdint_getname@@YAQBDPA18ssh_session_struct@Z" })
	String ssh_userauth_kbdint_getname(SshLibrary.ssh_session session);

	/**
	 * Original signature :
	 * <code>int ssh_userauth_kbdint_getnprompts(ssh_session)</code><br>
	 * <i>native declaration : /usr/include/libssh/libssh.h:384</i>
	 */
	@Mangling({ "_Z31ssh_userauth_kbdint_getnpromptsP18ssh_session_struct",
			"?ssh_userauth_kbdint_getnprompts@@YAHPA18ssh_session_struct@Z" })
	int ssh_userauth_kbdint_getnprompts(SshLibrary.ssh_session session);

	/**
	 * Original signature :
	 * <code>char* ssh_userauth_kbdint_getprompt(ssh_session, unsigned int, char*)</code><br>
	 * <i>native declaration : /usr/include/libssh/libssh.h:385</i><br>
	 * 
	 * @deprecated use the safer methods
	 *             {@link #ssh_userauth_kbdint_getprompt(ssh.SshLibrary.ssh_session, int, java.nio.ByteBuffer)}
	 *             and
	 *             {@link #ssh_userauth_kbdint_getprompt(ssh.SshLibrary.ssh_session, int, com.sun.jna.Pointer)}
	 *             instead
	 */
	@Mangling({ "_Z29ssh_userauth_kbdint_getpromptP18ssh_session_structjPc",
			"?ssh_userauth_kbdint_getprompt@@YAQBDPA18ssh_session_structIPAD@Z" })
	@Deprecated
	...
	/**
	 * Original signature :
	 * <code>int ssh_userauth_kbdint_setanswer(ssh_session, unsigned int, const char*)</code><br>
	 * <i>native declaration : /usr/include/libssh/libssh.h:386</i><br>
	 * 
	 * @deprecated use the safer methods
	 *             {@link #ssh_userauth_kbdint_setanswer(ssh.SshLibrary.ssh_session, int, java.lang.String)}
	 *             and
	 *             {@link #ssh_userauth_kbdint_setanswer(ssh.SshLibrary.ssh_session, int, com.sun.jna.Pointer)}
	 *             instead
	 */
	@Mangling({ "_Z29ssh_userauth_kbdint_setanswerP18ssh_session_structjPKc",
			"?ssh_userauth_kbdint_setanswer@@YAHPA18ssh_session_structIPAD@Z" })
	@Deprecated
	...
	/**
	 * Original signature :
	 * <code>int ssh_userauth_list(ssh_session, const char*)</code><br>
	 * <i>native declaration : /usr/include/libssh/libssh.h:388</i><br>
	 * 
	 * @deprecated use the safer methods
	 *             {@link #ssh_userauth_list(ssh.SshLibrary.ssh_session, java.lang.String)}
	 *             and
	 *             {@link #ssh_userauth_list(ssh.SshLibrary.ssh_session, com.sun.jna.Pointer)}
	 *             instead
	 */
	...
	/**
	 * Original signature :
	 * <code>int ssh_userauth_none(ssh_session, const char*)</code><br>
	 * <i>native declaration : /usr/include/libssh/libssh.h:389</i><br>
	 * 
	 * @deprecated use the safer methods
	 *             {@link #ssh_userauth_none(ssh.SshLibrary.ssh_session, java.lang.String)}
	 *             and
	 *             {@link #ssh_userauth_none(ssh.SshLibrary.ssh_session, com.sun.jna.Pointer)}
	 *             instead
	 */
	...
	/**
	 * Original signature :
	 * <code>int ssh_userauth_offer_pubkey(ssh_session, const char*, int, ssh_string)</code><br>
	 * <i>native declaration : /usr/include/libssh/libssh.h:390</i><br>
	 * 
	 * @deprecated use the safer methods
	 *             {@link #ssh_userauth_offer_pubkey(ssh.SshLibrary.ssh_session, java.lang.String, int, ssh.SshLibrary.ssh_string)}
	 *             and
	 *             {@link #ssh_userauth_offer_pubkey(ssh.SshLibrary.ssh_session, com.sun.jna.Pointer, int, ssh.SshLibrary.ssh_string)}
	 *             instead
	 */
	@Mangling({ "_Z25ssh_userauth_offer_pubkeyP18ssh_session_structPKciP17ssh_string_struct",
			"?ssh_userauth_offer_pubkey@@YAHPA18ssh_session_structPADHPA17ssh_string_struct@Z" })
	@Deprecated
	...
	/**
	 * Original signature :
	 * <code>int ssh_userauth_password(ssh_session, const char*, const char*)</code><br>
	 * <i>native declaration : /usr/include/libssh/libssh.h:391</i><br>
	 * 
	 * @deprecated use the safer methods
	 *             {@link #ssh_userauth_password(ssh.SshLibrary.ssh_session, java.lang.String, java.lang.String)}
	 *             and
	 *             {@link #ssh_userauth_password(ssh.SshLibrary.ssh_session, com.sun.jna.Pointer, com.sun.jna.Pointer)}
	 *             instead
	 */
	@Mangling({ "_Z21ssh_userauth_passwordP18ssh_session_structPKcPKc",
			"?ssh_userauth_password@@YAHPA18ssh_session_structPADPAD@Z" })
	@Deprecated
	...
	/**
	 * Original signature :
	 * <code>int ssh_userauth_pubkey(ssh_session, const char*, ssh_string, ssh_private_key)</code><br>
	 * <i>native declaration : /usr/include/libssh/libssh.h:392</i><br>
	 * 
	 * @deprecated use the safer methods
	 *             {@link #ssh_userauth_pubkey(ssh.SshLibrary.ssh_session, java.lang.String, ssh.SshLibrary.ssh_string, ssh.SshLibrary.ssh_private_key)}
	 *             and
	 *             {@link #ssh_userauth_pubkey(ssh.SshLibrary.ssh_session, com.sun.jna.Pointer, ssh.SshLibrary.ssh_string, ssh.SshLibrary.ssh_private_key)}
	 *             instead
	 */
	@Mangling({ "_Z19ssh_userauth_pubkeyP18ssh_session_structPKcP17ssh_string_structP22ssh_private_key_struct",
			"?ssh_userauth_pubkey@@YAHPA18ssh_session_structPADPA17ssh_string_structPA22ssh_private_key_struct@Z" })
	@Deprecated
	int ssh_userauth_pubkey(SshLibrary.ssh_session session, Pointer username, SshLibrary.ssh_string publickey,
	...
	@Mangling({ "_Z19ssh_userauth_pubkeyP18ssh_session_structPKcP17ssh_string_structP22ssh_private_key_struct",
			"?ssh_userauth_pubkey@@YAHPA18ssh_session_structPADPA17ssh_string_structPA22ssh_private_key_struct@Z" })
	int ssh_userauth_pubkey(SshLibrary.ssh_session session, String username, SshLibrary.ssh_string publickey,
			SshLibrary.ssh_private_key privatekey);

	/**
	 * Original signature :
	 * <code>int ssh_userauth_privatekey_file(ssh_session, const char*, const char*, const char*)</code><br>
	 * <i>native declaration : /usr/include/libssh/libssh.h:393</i><br>
	 * 
	 * @deprecated use the safer methods
	 *             {@link #ssh_userauth_privatekey_file(ssh.SshLibrary.ssh_session, java.lang.String, java.lang.String, java.lang.String)}
	 *             and
	 *             {@link #ssh_userauth_privatekey_file(ssh.SshLibrary.ssh_session, com.sun.jna.Pointer, com.sun.jna.Pointer, com.sun.jna.Pointer)}
	 *             instead
	 */
	@Mangling({ "_Z28ssh_userauth_privatekey_fileP18ssh_session_structPKcPKcPKc",
			"?ssh_userauth_privatekey_file@@YAHPA18ssh_session_structPADPADPAD@Z" })
	@Deprecated
	...
	/**
	 * Original signature :
	 * <code>int ssh_write_knownhost(ssh_session)</code><br>
	...
	/**
	 * Original signature :
	 * <code>ssh_string ssh_string_copy(ssh_string)</code><br>
	...
	/**
	 * Original signature :
	 * <code>int ssh_string_fill(ssh_string, const void*, size_t)</code><br>
	...
	/**
	 * Original signature :
	 * <code>ssh_string ssh_string_from_char(const char*)</code><br>
	 * <i>native declaration : /usr/include/libssh/libssh.h:403</i><br>
	 * 
	 * @deprecated use the safer methods
	 *             {@link #ssh_string_from_char(java.lang.String)} and
	 *             {@link #ssh_string_from_char(com.sun.jna.Pointer)} instead
	 */
	...
	/**
	 * Original signature :
	 * <code>char* ssh_string_to_char(ssh_string)</code><br>
	 ...
	 * 
	 * @deprecated use the safer methods
	 *             {@link #ssh_string_free_char(java.nio.ByteBuffer)} and
	 *             {@link #ssh_string_free_char(com.sun.jna.Pointer)} instead
	 */
	...
	/**
	 * Original signature :
	 * <code>int ssh_getpass(const char*, char*, size_t, int, int)</code><br>
	 * <i>native declaration : /usr/include/libssh/libssh.h:409</i><br>
	 * 
	 * @deprecated use the safer methods
	 *             {@link #ssh_getpass(java.lang.String, java.nio.ByteBuffer, com.ochafik.lang.jnaerator.runtime.NativeSize, int, int)}
	 *             and
	 *             {@link #ssh_getpass(com.sun.jna.Pointer, com.sun.jna.Pointer, com.ochafik.lang.jnaerator.runtime.NativeSize, int, int)}
	 *             instead
	 */
	 ...
	 *        Original signature :
	 *        <code>sftp_session sftp_new(ssh_session)</code><br>
	 ...
	 *        * Use this function to get the latest error set by a posix like
	 *        sftp function.<br>
	 *        * @param sftp The sftp session where the error is saved.<br>
	 *        * @return The saved error (see server responses), < 0 if an
	 *        error<br>
	 *        in the function occured.<br>
	 *        Original signature :
	 *        <code>int sftp_get_error(sftp_session)</code><br>
	 ...
	 *        * @return The count of extensions provided by the server, 0 on
	 *        error or<br>
	 *        not available.<br>
	 *        Original signature :
	 *        <code>int sftp_extensions_get_count(sftp_session)</code><br>
	 ...
	 *        * @param sftp The sftp session to use.<br>
	 *        * @param indexn The index number of the extension name you
	 *        want.<br>
	 *        * @return The name of the extension.<br>
	 *        Original signature :
	 *        <code>char* sftp_extensions_get_name(sftp_session, unsigned int)</code><br>
	 ...
	 *        * @param sftp The sftp session to use.<br>
	 *        * @param indexn The index number of the extension data you
	 *        want.<br>
	 *        * @return The data of the extension.<br>
	 *        Original signature :
	 *        <code>char* sftp_extensions_get_data(sftp_session, unsigned int)</code><br>
	 ...
	 * @endcode<br>
	 * 				Original signature :
	 *              <code>int sftp_extension_supported(sftp_session, const char*, const char*)</code><br>
	 *              <i>native declaration :
	 *              /usr/include/libssh/sftp.h:280</i><br>
	 * @deprecated use the safer methods
	 *             {@link #sftp_extension_supported(ssh.sftp_session_struct, java.lang.String, java.lang.String)}
	 *             and
	 *             {@link #sftp_extension_supported(ssh.sftp_session_struct, com.sun.jna.Pointer, com.sun.jna.Pointer)}
	 *             instead
	 */
	@Deprecated
	 ...
	 *            * @return A sftp directory handle or NULL on error with ssh
	 *            and<br>
	 *            sftp error set.<br>
	 *            * @see sftp_readdir<br>
	 * @see sftp_closedir<br>
	 *      Original signature :
	 *      <code>sftp_dir sftp_opendir(sftp_session, const char*)</code><br>
	 *      <i>native declaration : /usr/include/libssh/sftp.h:295</i><br>
	 * @deprecated use the safer methods
	 *             {@link #sftp_opendir(ssh.sftp_session_struct, java.lang.String)}
	 *             and
	 *             {@link #sftp_opendir(ssh.sftp_session_struct, com.sun.jna.Pointer)}
	 *             instead
	 */
	@Deprecated
	 ...
	 *        * @param session The sftp session handle to read the directory
	 *        entry.<br>
	 * @param dir The opened sftp directory handle to read from.<br>
	 *            * @return A file attribute structure or NULL at the end of
	 *            the<br>
	 *            directory.<br>
	 *            * @see sftp_opendir()<br>
	 ...
	 * @see sftp_closedir()<br>
	 *      Original signature :
	 *      <code>sftp_attributes sftp_readdir(sftp_session, sftp_dir)</code><br>
	 ...
	 *            information.<br>
	 *            * @return The sftp attributes structure of the file or
	 *            directory,<br>
	 *            NULL on error with ssh and sftp error set.<br>
	 *            Original signature :
	 *            <code>sftp_attributes sftp_stat(sftp_session, const char*)</code><br>
	 *            <i>native declaration : /usr/include/libssh/sftp.h:333</i><br>
	 * @deprecated use the safer methods
	 *             {@link #sftp_stat(ssh.sftp_session_struct, java.lang.String)}
	 *             and
	 *             {@link #sftp_stat(ssh.sftp_session_struct, com.sun.jna.Pointer)}
	 *             instead
	 */
	@Deprecated
	...
	/**
	 * @brief Get information about a file or directory.<br>
	 *        * Identical to sftp_stat, but if the file or directory is a
	 *        symbolic link,<br>
	 *        then the link itself is stated, not the file that it refers
	 *        to.<br>
	 *        * @param session The sftp session handle.<br>
	 * @param path The path to the file or directory to obtain the<br>
	 *            information.<br>
	 ...
	 *            NULL on error with ssh and sftp error set.<br>
	 *            Original signature :
	 *            <code>sftp_attributes sftp_lstat(sftp_session, const char*)</code><br>
	 *            <i>native declaration : /usr/include/libssh/sftp.h:348</i><br>
	 * @deprecated use the safer methods
	 *             {@link #sftp_lstat(ssh.sftp_session_struct, java.lang.String)}
	 *             and
	 *             {@link #sftp_lstat(ssh.sftp_session_struct, com.sun.jna.Pointer)}
	 *             instead
	 */
	@Deprecated
	 ...
	 *        * @param file The sftp file handle to get the stat
	 *        information.<br>
	 *        * @return The sftp attributes structure of the file or
	 *        directory,<br>
	 *        NULL on error with ssh and sftp error set.<br>
	 *        Original signature :
	 *        <code>sftp_attributes sftp_fstat(sftp_file)</code><br>
	 ...
	 *        Original signature :
	 *        <code>void sftp_attributes_free(sftp_attributes)</code><br>
	 ...
	 *        * @return Returns SSH_NO_ERROR or SSH_ERROR if an error
	 *        occured.<br>
	 ...
	 *        * @param accesstype Is one of O_RDONLY, O_WRONLY or O_RDWR which
	 *        request<br>
	 ...
	 *        truncated.<br>
	 *        * @param mode Mode specifies the permissions to use if a new file
	 *        is<br>
	 ...
	 *        error set.<br>
	 *        Original signature :
	 *        <code>sftp_file sftp_open(sftp_session, const char*, int, mode_t)</code><br>
	 *        <i>native declaration : /usr/include/libssh/sftp.h:413</i><br>
	 * @deprecated use the safer methods
	 *             {@link #sftp_open(ssh.sftp_session_struct, java.lang.String, int, int)}
	 *             and
	 *             {@link #sftp_open(ssh.sftp_session_struct, com.sun.jna.Pointer, int, int)}
	 *             instead
	 */
	@Deprecated
	...
	/**
	 * Original signature :
	 * <code>void sftp_file_set_nonblocking(sftp_file)</code><br>
	...
	/**
	 * Original signature :
	 * <code>void sftp_file_set_blocking(sftp_file)</code><br>
	 ...
	 *        * @return Number of bytes written, < 0 on error with ssh and
	 *        sftp<br>
	 *        error set.<br>
	 *        Original signature :
	 *        <code>ssize_t sftp_read(sftp_file, void*, size_t)</code><br>
	 *        <i>native declaration : /usr/include/libssh/sftp.h:432</i>
	 */
	int sftp_read(sftp_file_struct file, Pointer buf, NativeSize count);

	/**
	 * @brief Start an asynchronous read from a file using an opened sftp file
	 *        handle.<br>
	 *        * Its goal is to avoid the slowdowns related to the
	 ...
	 *        * The first step is to call sftp_async_read_begin(). This function
	 *        returns a<br>
	 *        request identifier. The second step is to call sftp_async_read()
	 *        using the<br>
	 *        returned identifier.<br>
	 *        * @param file The opened sftp file handle to be read from.<br>
	 *        * @param len Size to read in bytes.<br>
	 *        * @return An identifier corresponding to the sent request, < 0
	 *        on<br>
	 *        error.<br>
	 *        * @warning When calling this function, the internal offset is<br>
	 *        updated corresponding to the len parameter.<br>
	 *        * @warning A call to sftp_async_read_begin() sends a request
	 *        to<br>
	 ...
	 * @see sftp_open()<br>
	 *      Original signature :
	 *      <code>int sftp_async_read_begin(sftp_file, uint32_t)</code><br>
	 ...
	 *        * @param len Size of the buffer in bytes. It should be bigger
	 *        or<br>
	 *        equal to the length parameter of the<br>
	 *        sftp_async_read_begin() call.<br>
	 *        * @param id The identifier returned by the
	 *        sftp_async_read_begin()<br>
	 *        function.<br>
	 *        * @return Number of bytes read, 0 on EOF, SSH_ERROR if an
	 *        error<br>
	 ...
	 *        Original signature :
	 *        <code>int sftp_async_read(sftp_file, void*, uint32_t, uint32_t)</code><br>
	 ...
	 * @see sftp_close()<br>
	 *      Original signature :
	 *      <code>ssize_t sftp_write(sftp_file, const void*, size_t)</code><br>
	 ...
	 *        Original signature :
	 *        <code>int sftp_seek(sftp_file, uint32_t)</code><br>
	 ...
	 *        * @return 0 on success, < 0 on error.<br>
	 *        Original signature :
	 *        <code>int sftp_seek64(sftp_file, uint64_t)</code><br>
	 ...
	 *        * @return The offset of the current byte relative to the
	 *        beginning<br>
	 ...
	 *        error.<br>
	 *        Original signature :
	 *        <code>uint64_t sftp_tell64(sftp_file)</code><br>
	 *        <i>native declaration : /usr/include/libssh/sftp.h:553</i>
	 */
	long sftp_tell64(sftp_file_struct file);

	/**
	 * @brief Rewinds the position of the file pointer to the beginning of
	 *        the<br>
	 *        file.<br>
	 *        * @param file Open sftp file handle.<br>
	 ...
	 *        * @return 0 on success, < 0 on error with ssh and sftp error
	 *        set.<br>
	 *        Original signature :
	 *        <code>int sftp_unlink(sftp_session, const char*)</code><br>
	 *        <i>native declaration : /usr/include/libssh/sftp.h:572</i><br>
	 * @deprecated use the safer methods
	 *             {@link #sftp_unlink(ssh.sftp_session_struct, java.lang.String)}
	 *             and
	 *             {@link #sftp_unlink(ssh.sftp_session_struct, com.sun.jna.Pointer)}
	 *             instead
	 */
	@Deprecated
	 ...
	 *        set.<br>
	 *        Original signature :
	 *        <code>int sftp_rmdir(sftp_session, const char*)</code><br>
	 *        <i>native declaration : /usr/include/libssh/sftp.h:583</i><br>
	 * @deprecated use the safer methods
	 *             {@link #sftp_rmdir(ssh.sftp_session_struct, java.lang.String)}
	 *             and
	 *             {@link #sftp_rmdir(ssh.sftp_session_struct, com.sun.jna.Pointer)}
	 *             instead
	 */
	@Deprecated
	 ...
	 *        * @param mode Specifies the permissions to use. It is modified by
	 *        the<br>
	 ...
	 *        set.<br>
	 *        Original signature :
	 *        <code>int sftp_mkdir(sftp_session, const char*, mode_t)</code><br>
	 *        <i>native declaration : /usr/include/libssh/sftp.h:598</i><br>
	 * @deprecated use the safer methods
	 *             {@link #sftp_mkdir(ssh.sftp_session_struct, java.lang.String, int)}
	 *             and
	 *             {@link #sftp_mkdir(ssh.sftp_session_struct, com.sun.jna.Pointer, int)}
	 *             instead
	 */
	@Deprecated
	 ...
	 *        * @param sftp The sftp session handle.<br>
	 *        * @param original The original url (source url) of file or
	 *        directory to<br>
	 *        be moved.<br>
	 *        * @param newname The new url (destination url) of the file or
	 *        directory<br>
	 *        after the move.<br>
	 *        * @return 0 on success, < 0 on error with ssh and sftp error
	 *        set.<br>
	 *        Original signature :
	 *        <code>int sftp_rename(sftp_session, const char*, const char*)</code><br>
	 *        <i>native declaration : /usr/include/libssh/sftp.h:613</i><br>
	 * @deprecated use the safer methods
	 *             {@link #sftp_rename(ssh.sftp_session_struct, java.lang.String, java.lang.String)}
	 *             and
	 *             {@link #sftp_rename(ssh.sftp_session_struct, com.sun.jna.Pointer, com.sun.jna.Pointer)}
	 *             instead
	 */
	@Deprecated
	 ...
	 *        * @param attr The file attributes structure with the attributes
	 *        set<br>
	 *        which should be changed.<br>
	 *        * @return 0 on success, < 0 on error with ssh and sftp error
	 *        set.<br>
	 *        Original signature :
	 *        <code>int sftp_setstat(sftp_session, const char*, sftp_attributes)</code><br>
	 *        <i>native declaration : /usr/include/libssh/sftp.h:627</i><br>
	 * @deprecated use the safer methods
	 *             {@link #sftp_setstat(ssh.sftp_session_struct, java.lang.String, ssh.sftp_attributes_struct)}
	 *             and
	 *             {@link #sftp_setstat(ssh.sftp_session_struct, com.sun.jna.Pointer, ssh.sftp_attributes_struct)}
	 *             instead
	 */
	@Deprecated
	 ...
	 *        * @param sftp The sftp session handle.<br>
	 *        * @param file The file which owner and group should be
	 *        changed.<br>
	 ...
	 *        set.<br>
	 *        Original signature :
	 *        <code>int sftp_chown(sftp_session, const char*, uid_t, gid_t)</code><br>
	 *        <i>native declaration : /usr/include/libssh/sftp.h:642</i><br>
	 * @deprecated use the safer methods
	 *             {@link #sftp_chown(ssh.sftp_session_struct, java.lang.String, int, int)}
	 *             and
	 *             {@link #sftp_chown(ssh.sftp_session_struct, com.sun.jna.Pointer, int, int)}
	 *             instead
	 */
	@Deprecated
	 ...
	 *        set.<br>
	 *        Original signature :
	 *        <code>int sftp_chmod(sftp_session, const char*, mode_t)</code><br>
	 *        <i>native declaration : /usr/include/libssh/sftp.h:657</i><br>
	 * @deprecated use the safer methods
	 *             {@link #sftp_chmod(ssh.sftp_session_struct, java.lang.String, int)}
	 *             and
	 *             {@link #sftp_chmod(ssh.sftp_session_struct, com.sun.jna.Pointer, int)}
	 *             instead
	 */
	@Deprecated
	 ...
	 *        * @param file The file which owner and group should be
	 *        changed.<br>
	 *        * @param times A timeval structure which contains the desired
	 *        access<br>
	 *        and modification time.<br>
	 *        * @return 0 on success, < 0 on error with ssh and sftp error
	 *        set.<br>
	 *        Original signature :
	 *        <code>int sftp_utimes(sftp_session, const char*, timeval*)</code><br>
	 *        <i>native declaration : /usr/include/libssh/sftp.h:671</i><br>
	 * @deprecated use the safer methods
	 *             {@link #sftp_utimes(ssh.sftp_session_struct, java.lang.String, com.sun.jna.Pointer)}
	 *             and
	 *             {@link #sftp_utimes(ssh.sftp_session_struct, com.sun.jna.Pointer, com.sun.jna.Pointer)}
	 *             instead
	 */
	@Deprecated
	 ...
	 *        * @param dest Specifies the path name of the symlink to be
	 *        created.<br>
	 *        * @return 0 on success, < 0 on error with ssh and sftp error
	 *        set.<br>
	 *        Original signature :
	 *        <code>int sftp_symlink(sftp_session, const char*, const char*)</code><br>
	 *        <i>native declaration : /usr/include/libssh/sftp.h:684</i><br>
	 * @deprecated use the safer methods
	 *             {@link #sftp_symlink(ssh.sftp_session_struct, java.lang.String, java.lang.String)}
	 *             and
	 *             {@link #sftp_symlink(ssh.sftp_session_struct, com.sun.jna.Pointer, com.sun.jna.Pointer)}
	 *             instead
	 */
	@Deprecated
	 ...
	 *        * @param sftp The sftp session handle.<br>
	 *        * @param path Specifies the path name of the symlink to be
	 *        read.<br>
	 *        * @return The target of the link, NULL on error.<br>
	 *        Original signature :
	 *        <code>char* sftp_readlink(sftp_session, const char*)</code><br>
	 *        <i>native declaration : /usr/include/libssh/sftp.h:695</i><br>
	 * @deprecated use the safer methods
	 *             {@link #sftp_readlink(ssh.sftp_session_struct, java.lang.String)}
	 *             and
	 *             {@link #sftp_readlink(ssh.sftp_session_struct, com.sun.jna.Pointer)}
	 *             instead
	 */
	@Deprecated
	 ...
	 *        * @param sftp The sftp session handle.<br>
	 *        * @param path The pathname of any file within the mounted file
	 *        system.<br>
	 *        * @return A statvfs structure or NULL on error.<br>
	 *        Original signature :
	 *        <code>sftp_statvfs_t sftp_statvfs(sftp_session, const char*)</code><br>
	 *        <i>native declaration : /usr/include/libssh/sftp.h:706</i><br>
	 * @deprecated use the safer methods
	 *             {@link #sftp_statvfs(ssh.sftp_session_struct, java.lang.String)}
	 *             and
	 *             {@link #sftp_statvfs(ssh.sftp_session_struct, com.sun.jna.Pointer)}
	 *             instead
	 */
	@Deprecated
	 ...
	 *        * @return A statvfs structure or NULL on error.<br>
	 *        Original signature :
	 *        <code>sftp_statvfs_t sftp_fstatvfs(sftp_file)</code><br>
	 ...
	 *        Original signature :
	 *        <code>void sftp_statvfs_free(sftp_statvfs_t)</code><br>
	 ...
	 *        Original signature :
	 *        <code>char* sftp_canonicalize_path(sftp_session, const char*)</code><br>
	 *        <i>native declaration : /usr/include/libssh/sftp.h:733</i><br>
	 * @deprecated use the safer methods
	 *             {@link #sftp_canonicalize_path(ssh.sftp_session_struct, java.lang.String)}
	 *             and
	 *             {@link #sftp_canonicalize_path(ssh.sftp_session_struct, com.sun.jna.Pointer)}
	 *             instead
	 */
	@Deprecated
	 ...
	 *        Original signature :
	 *        <code>int sftp_server_version(sftp_session)</code><br>
	...
	/**
	 * Original signature :
	 * <code>sftp_packet sftp_packet_read(sftp_session)</code><br>
	...
	/**
	 * Original signature :
	 * <code>int sftp_packet_write(sftp_session, uint8_t, ssh_buffer)</code><br>
	...
	/**
	 * Original signature :
	 * <code>int buffer_add_attributes(ssh_buffer, sftp_attributes)</code><br>
	...
	/**
	 * Original signature :
	 * <code>sftp_attributes sftp_parse_attr(sftp_session, ssh_buffer, int)</code><br>
	...
	/**
	 * Original signature :
	 * <code>sftp_client_message sftp_get_client_message(sftp_session)</code><br>
	...
	/**
	 * Original signature :
	 * <code>void sftp_client_message_free(sftp_client_message)</code><br>
	...
	/**
	 * Original signature :
	 * <code>int sftp_reply_name(sftp_client_message, const char*, sftp_attributes)</code><br>
	 * <i>native declaration : /usr/include/libssh/sftp.h:777</i><br>
	 * 
	 * @deprecated use the safer methods
	 *             {@link #sftp_reply_name(ssh.sftp_client_message_struct, java.lang.String, ssh.sftp_attributes_struct)}
	 *             and
	 *             {@link #sftp_reply_name(ssh.sftp_client_message_struct, com.sun.jna.Pointer, ssh.sftp_attributes_struct)}
	 *             instead
	 */
	@Deprecated
	...
	/**
	 * Original signature :
	 * <code>int sftp_reply_handle(sftp_client_message, ssh_string)</code><br>
	...
	/**
	 * Original signature :
	 * <code>ssh_string sftp_handle_alloc(sftp_session, void*)</code><br>
	...
	/**
	 * Original signature :
	 * <code>int sftp_reply_attr(sftp_client_message, sftp_attributes)</code><br>
	...
	/**
	 * Original signature :
	 * <code>void* sftp_handle(sftp_session, ssh_string)</code><br>
	...
	/**
	 * Original signature :
	 * <code>int sftp_reply_status(sftp_client_message, uint32_t, const char*)</code><br>
	 * <i>native declaration : /usr/include/libssh/sftp.h:783</i><br>
	 * 
	 * @deprecated use the safer methods
	 *             {@link #sftp_reply_status(ssh.sftp_client_message_struct, int, java.lang.String)}
	 *             and
	 *             {@link #sftp_reply_status(ssh.sftp_client_message_struct, int, com.sun.jna.Pointer)}
	 *             instead
	 */
	@Deprecated
	...
	/**
	 * Original signature :
	 * <code>int sftp_reply_names_add(sftp_client_message, const char*, const char*, sftp_attributes)</code><br>
	 * <i>native declaration : /usr/include/libssh/sftp.h:784</i><br>
	 * 
	 * @deprecated use the safer methods
	 *             {@link #sftp_reply_names_add(ssh.sftp_client_message_struct, java.lang.String, java.lang.String, ssh.sftp_attributes_struct)}
	 *             and
	 *             {@link #sftp_reply_names_add(ssh.sftp_client_message_struct, com.sun.jna.Pointer, com.sun.jna.Pointer, ssh.sftp_attributes_struct)}
	 *             instead
	 */
	@Deprecated
	...
	/**
	 * Original signature :
	 * <code>int sftp_reply_names(sftp_client_message)</code><br>
	...
	/**
	 * Original signature :
	 * <code>int sftp_reply_data(sftp_client_message, const void*, int)</code><br>
	...
	/**
	 * Original signature :
	 * <code>void sftp_handle_remove(sftp_session, void*)</code><br>
	 ...
	 *        * This functions sets the callback structure to use your own
	 *        callback<br>
	 ...
	 * @endcode<br>
	 * 				* @param session The session to set the callback
	 *              structure.<br>
	 *              * @param cb The callback structure itself.<br>
	 *              * @return SSH_OK on success, SSH_ERROR on error.<br>
	 *              Original signature :
	 *              <code>int ssh_set_callbacks(ssh_session, ssh_callbacks)</code><br>
	 *              <i>native declaration :
	 *              /usr/include/libssh/callbacks.h:271</i>
	 */
	 ...
	 * @endcode<br>
	 * 				* @param channel The channel to set the callback
	 *              structure.<br>
	 *              * @param cb The callback structure itself.<br>
	 *              * @return SSH_OK on success, SSH_ERROR on error.<br>
	 *              Original signature :
	 *              <code>int ssh_set_channel_callbacks(ssh_channel, ssh_channel_callbacks)</code><br>
	 *              <i>native declaration :
	 *              /usr/include/libssh/callbacks.h:405</i>
	 */
	 ...
	 *        libssh in a multithreaded fashion. This function must be called
	 *        first,<br>
	 *        outside of any threading context (in your main() for instance),
	 *        before<br>
	 *        ssh_init().<br>
	 * @param cb pointer to a ssh_threads_callbacks_struct structure, which
	 *            contains<br>
	 *            the different callbacks to be set.<br>
	 * @see ssh_threads_callbacks_struct<br>
	 * @see SSH_THREADS_PTHREAD<br>
	 *      Original signature :
	 *      <code>int ssh_threads_set_callbacks(ssh_threads_callbacks_struct*)</code><br>
	 *      <i>native declaration : /usr/include/libssh/callbacks.h:436</i>
	 */
	int ssh_threads_set_callbacks(ssh_threads_callbacks_struct cb);

	/**
	 * @brief returns a pointer on the pthread threads callbacks, to be used
	 *        with<br>
	 *        ssh_threads_set_callbacks.<br>
	 * @warning you have to link with the library ssh_threads.<br>
	 * @see ssh_threads_set_callbacks<br>
	 *      Original signature :
	 *      <code>ssh_threads_callbacks_struct* ssh_threads_get_pthread()</code><br>
	 *      <i>native declaration : /usr/include/libssh/callbacks.h:445</i>
	 */
	ssh_threads_callbacks_struct ssh_threads_get_pthread();

	/**
	 * @brief returns a pointer on the noop threads callbacks, to be used
	 *        with<br>
	 *        ssh_threads_set_callbacks. These callbacks do nothing and are
	 *        being used by<br>
	 *        default.<br>
	 * @see ssh_threads_set_callbacks<br>
	 *      Original signature :
	 *      <code>ssh_threads_callbacks_struct* ssh_threads_get_noop()</code><br>
	...
	/**
	 * Original signature :
	 * <code>ssh_channel channel_accept_x11(ssh_channel, int)</code><br>
	 * <i>native declaration : /usr/include/libssh/legacy.h:39</i>
	 */
	@Mangling({ "_Z18channel_accept_x11P18ssh_channel_structi",
			"?channel_accept_x11@@YAPA18ssh_channel_structPA18ssh_channel_structH@Z" })
	SshLibrary.ssh_channel channel_accept_x11(SshLibrary.ssh_channel channel, int timeout_ms);

	/**
	 * Original signature :
	 * <code>int channel_change_pty_size(ssh_channel, int, int)</code><br>
	...
	/**
	 * Original signature :
	 * <code>ssh_channel channel_forward_accept(ssh_session, int)</code><br>
	 * <i>native declaration : /usr/include/libssh/legacy.h:41</i>
	 */
	@Mangling({ "_Z22channel_forward_acceptP18ssh_session_structi",
			"?channel_forward_accept@@YAPA18ssh_channel_structPA18ssh_session_structH@Z" })
	...
	/**
	 * Original signature :
	 * <code>int channel_forward_cancel(ssh_session, const char*, int)</code><br>
	 * <i>native declaration : /usr/include/libssh/legacy.h:43</i><br>
	 * 
	 * @deprecated use the safer methods
	 *             {@link #channel_forward_cancel(ssh.SshLibrary.ssh_session, java.lang.String, int)}
	 *             and
	 *             {@link #channel_forward_cancel(ssh.SshLibrary.ssh_session, com.sun.jna.Pointer, int)}
	 *             instead
	 */
	...
	/**
	 * Original signature :
	 * <code>int channel_forward_listen(ssh_session, const char*, int, int*)</code><br>
	 * <i>native declaration : /usr/include/libssh/legacy.h:44</i><br>
	 * 
	 * @deprecated use the safer methods
	 *             {@link #channel_forward_listen(ssh.SshLibrary.ssh_session, java.lang.String, int, java.nio.IntBuffer)}
	 *             and
	 *             {@link #channel_forward_listen(ssh.SshLibrary.ssh_session, com.sun.jna.Pointer, int, com.sun.jna.ptr.IntByReference)}
	 *             instead
	 */
	@Mangling({ "_Z22channel_forward_listenP18ssh_session_structPKciPi",
			"?channel_forward_listen@@YAHPA18ssh_session_structPADHPAH@Z" })
	@Deprecated
	...
	/**
	 * Original signature :
	 * <code>int channel_get_exit_status(ssh_channel)</code><br>
	...
	/**
	 * Original signature :
	 * <code>ssh_session channel_get_session(ssh_channel)</code><br>
	 * <i>native declaration : /usr/include/libssh/legacy.h:47</i>
	 */
	@Mangling({ "_Z19channel_get_sessionP18ssh_channel_struct",
			"?channel_get_session@@YAPA18ssh_session_structPA18ssh_channel_struct@Z" })
	...
	/**
	 * Original signature :
	 * <code>ssh_channel channel_new(ssh_session)</code><br>
	...
	/**
	 * Original signature :
	 * <code>int channel_open_forward(ssh_channel, const char*, int, const char*, int)</code><br>
	 * <i>native declaration : /usr/include/libssh/legacy.h:52</i><br>
	 * 
	 * @deprecated use the safer methods
	 *             {@link #channel_open_forward(ssh.SshLibrary.ssh_channel, java.lang.String, int, java.lang.String, int)}
	 *             and
	 *             {@link #channel_open_forward(ssh.SshLibrary.ssh_channel, com.sun.jna.Pointer, int, com.sun.jna.Pointer, int)}
	 *             instead
	 */
	@Mangling({ "_Z20channel_open_forwardP18ssh_channel_structPKciPKci",
			"?channel_open_forward@@YAHPA18ssh_channel_structPADHPADH@Z" })
	@Deprecated
	...
	/**
	 * Original signature :
	 * <code>int channel_open_session(ssh_channel)</code><br>
	...
	/**
	 * Original signature :
	 * <code>int channel_read(ssh_channel, void*, uint32_t, int)</code><br>
	...
	/**
	 * Original signature :
	 * <code>int channel_read_buffer(ssh_channel, ssh_buffer, uint32_t, int)</code><br>
	 * <i>native declaration : /usr/include/libssh/legacy.h:58</i>
	 */
	@Mangling({ "_Z19channel_read_bufferP18ssh_channel_structP17ssh_buffer_struct8uint32_ti",
			"?channel_read_buffer@@YAHPA18ssh_channel_structPA17ssh_buffer_struct8uint32_tH@Z" })
	int channel_read_buffer(SshLibrary.ssh_channel channel, SshLibrary.ssh_buffer buffer, int count, int is_stderr);

	/**
	 * Original signature :
	 * <code>int channel_read_nonblocking(ssh_channel, void*, uint32_t, int)</code><br>
	 * <i>native declaration : /usr/include/libssh/legacy.h:61</i>
	 */
	@Mangling({ "_Z24channel_read_nonblockingP18ssh_channel_structPv8uint32_ti",
			"?channel_read_nonblocking@@YAHPA18ssh_channel_structPAX8uint32_tH@Z" })
	int channel_read_nonblocking(SshLibrary.ssh_channel channel, Pointer dest, int count, int is_stderr);

	/**
	 * Original signature :
	 * <code>int channel_request_env(ssh_channel, const char*, const char*)</code><br>
	 * <i>native declaration : /usr/include/libssh/legacy.h:63</i><br>
	 * 
	 * @deprecated use the safer methods
	 *             {@link #channel_request_env(ssh.SshLibrary.ssh_channel, java.lang.String, java.lang.String)}
	 *             and
	 *             {@link #channel_request_env(ssh.SshLibrary.ssh_channel, com.sun.jna.Pointer, com.sun.jna.Pointer)}
	 *             instead
	 */
	...
	/**
	 * Original signature :
	 * <code>int channel_request_exec(ssh_channel, const char*)</code><br>
	 * <i>native declaration : /usr/include/libssh/legacy.h:64</i><br>
	 * 
	 * @deprecated use the safer methods
	 *             {@link #channel_request_exec(ssh.SshLibrary.ssh_channel, java.lang.String)}
	 *             and
	 *             {@link #channel_request_exec(ssh.SshLibrary.ssh_channel, com.sun.jna.Pointer)}
	 *             instead
	 */
	...
	/**
	 * Original signature :
	 * <code>int channel_request_pty(ssh_channel)</code><br>
	...
	/**
	 * Original signature :
	 * <code>int channel_request_pty_size(ssh_channel, const char*, int, int)</code><br>
	 * <i>native declaration : /usr/include/libssh/legacy.h:66</i><br>
	 * 
	 * @deprecated use the safer methods
	 *             {@link #channel_request_pty_size(ssh.SshLibrary.ssh_channel, java.lang.String, int, int)}
	 *             and
	 *             {@link #channel_request_pty_size(ssh.SshLibrary.ssh_channel, com.sun.jna.Pointer, int, int)}
	 *             instead
	 */
	@Mangling({ "_Z24channel_request_pty_sizeP18ssh_channel_structPKcii",
			"?channel_request_pty_size@@YAHPA18ssh_channel_structPADHH@Z" })
	@Deprecated
	...
	/**
	 * Original signature :
	 * <code>int channel_request_shell(ssh_channel)</code><br>
	...
	/**
	 * Original signature :
	 * <code>int channel_request_send_signal(ssh_channel, const char*)</code><br>
	 * <i>native declaration : /usr/include/libssh/legacy.h:69</i><br>
	 * 
	 * @deprecated use the safer methods
	 *             {@link #channel_request_send_signal(ssh.SshLibrary.ssh_channel, java.lang.String)}
	 *             and
	 *             {@link #channel_request_send_signal(ssh.SshLibrary.ssh_channel, com.sun.jna.Pointer)}
	 *             instead
	 */
	@Mangling({ "_Z27channel_request_send_signalP18ssh_channel_structPKc",
			"?channel_request_send_signal@@YAHPA18ssh_channel_structPAD@Z" })
	@Deprecated
	...
	/**
	 * Original signature :
	 * <code>int channel_request_sftp(ssh_channel)</code><br>
	...
	/**
	 * Original signature :
	 * <code>int channel_request_subsystem(ssh_channel, const char*)</code><br>
	 * <i>native declaration : /usr/include/libssh/legacy.h:71</i><br>
	 * 
	 * @deprecated use the safer methods
	 *             {@link #channel_request_subsystem(ssh.SshLibrary.ssh_channel, java.lang.String)}
	 *             and
	 *             {@link #channel_request_subsystem(ssh.SshLibrary.ssh_channel, com.sun.jna.Pointer)}
	 *             instead
	 */
	@Mangling({ "_Z25channel_request_subsystemP18ssh_channel_structPKc",
			"?channel_request_subsystem@@YAHPA18ssh_channel_structPAD@Z" })
	@Deprecated
	...
	/**
	 * Original signature :
	 * <code>int channel_request_x11(ssh_channel, int, const char*, const char*, int)</code><br>
	 * <i>native declaration : /usr/include/libssh/legacy.h:72</i><br>
	 * 
	 * @deprecated use the safer methods
	 *             {@link #channel_request_x11(ssh.SshLibrary.ssh_channel, int, java.lang.String, java.lang.String, int)}
	 *             and
	 *             {@link #channel_request_x11(ssh.SshLibrary.ssh_channel, int, com.sun.jna.Pointer, com.sun.jna.Pointer, int)}
	 *             instead
	 */
	@Mangling({ "_Z19channel_request_x11P18ssh_channel_structiPKcPKci",
			"?channel_request_x11@@YAHPA18ssh_channel_structHPADPADH@Z" })
	@Deprecated
	int channel_request_x11(SshLibrary.ssh_channel channel, int single_connection, Pointer protocol, Pointer cookie,
			int screen_number);
	...
	@Mangling({ "_Z19channel_request_x11P18ssh_channel_structiPKcPKci",
			"?channel_request_x11@@YAHPA18ssh_channel_structHPADPADH@Z" })
	int channel_request_x11(SshLibrary.ssh_channel channel, int single_connection, String protocol, String cookie,
			int screen_number);
	...
	/**
	 * Original signature :
	 * <code>int channel_select(ssh_channel*, ssh_channel*, ssh_channel*, timeval*)</code><br>
	 * <i>native declaration : /usr/include/libssh/legacy.h:75</i>
	 */
	@Mangling({ "_Z14channel_selectPP18ssh_channel_structPP18ssh_channel_structPP18ssh_channel_structP7timeval",
			"?channel_select@@YAHPAPA18ssh_channel_structPAPA18ssh_channel_structPAPA18ssh_channel_structPA7timeval@Z" })
	int channel_select(PointerByReference readchans, PointerByReference writechans, PointerByReference exceptchans,
			Pointer timeout);

	/**
	 * Original signature :
	 * <code>void channel_set_blocking(ssh_channel, int)</code><br>
	...
	/**
	 * Original signature :
	 * <code>int channel_write(ssh_channel, const void*, uint32_t)</code><br>
	...
	/**
	 * Original signature :
	 * <code>void privatekey_free(ssh_private_key)</code><br>
	...
	/**
	 * Original signature :
	 * <code>ssh_private_key privatekey_from_file(ssh_session, const char*, int, const char*)</code><br>
	 * <i>native declaration : /usr/include/libssh/legacy.h:81</i><br>
	 * 
	 * @deprecated use the safer methods
	 *             {@link #privatekey_from_file(ssh.SshLibrary.ssh_session, java.lang.String, int, java.lang.String)}
	 *             and
	 *             {@link #privatekey_from_file(ssh.SshLibrary.ssh_session, com.sun.jna.Pointer, int, com.sun.jna.Pointer)}
	 *             instead
	 */
	@Mangling({ "_Z20privatekey_from_fileP18ssh_session_structPKciPKc",
			"?privatekey_from_file@@YAPA22ssh_private_key_structPA18ssh_session_structPADHPAD@Z" })
	@Deprecated
	...
	/**
	 * Original signature :
	 * <code>int ssh_publickey_to_file(ssh_session, const char*, ssh_string, int)</code><br>
	 * <i>native declaration : /usr/include/libssh/legacy.h:84</i><br>
	 * 
	 * @deprecated use the safer methods
	 *             {@link #ssh_publickey_to_file(ssh.SshLibrary.ssh_session, java.lang.String, ssh.SshLibrary.ssh_string, int)}
	 *             and
	 *             {@link #ssh_publickey_to_file(ssh.SshLibrary.ssh_session, com.sun.jna.Pointer, ssh.SshLibrary.ssh_string, int)}
	 *             instead
	 */
	@Mangling({ "_Z21ssh_publickey_to_fileP18ssh_session_structPKcP17ssh_string_structi",
			"?ssh_publickey_to_file@@YAHPA18ssh_session_structPADPA17ssh_string_structH@Z" })
	@Deprecated
	...
	/**
	 * Original signature :
	 * <code>ssh_string publickey_from_file(ssh_session, const char*, int*)</code><br>
	 * <i>native declaration : /usr/include/libssh/legacy.h:86</i><br>
	 * 
	 * @deprecated use the safer methods
	 *             {@link #publickey_from_file(ssh.SshLibrary.ssh_session, java.lang.String, java.nio.IntBuffer)}
	 *             and
	 *             {@link #publickey_from_file(ssh.SshLibrary.ssh_session, com.sun.jna.Pointer, com.sun.jna.ptr.IntByReference)}
	 *             instead
	 */
	@Mangling({ "_Z19publickey_from_fileP18ssh_session_structPKcPi",
			"?publickey_from_file@@YAPA17ssh_string_structPA18ssh_session_structPADPAH@Z" })
	@Deprecated
	...
	/**
	 * Original signature :
	 * <code>ssh_public_key publickey_from_privatekey(ssh_private_key)</code><br>
	 * <i>native declaration : /usr/include/libssh/legacy.h:88</i>
	 */
	@Mangling({ "_Z25publickey_from_privatekeyP22ssh_private_key_struct",
			"?publickey_from_privatekey@@YAPA21ssh_public_key_structPA22ssh_private_key_struct@Z" })
	SshLibrary.ssh_public_key publickey_from_privatekey(SshLibrary.ssh_private_key prv);

	/**
	 * Original signature :
	 * <code>ssh_string publickey_to_string(ssh_public_key)</code><br>
	 * <i>native declaration : /usr/include/libssh/legacy.h:89</i>
	 */
	@Mangling({ "_Z19publickey_to_stringP21ssh_public_key_struct",
			"?publickey_to_string@@YAPA17ssh_string_structPA21ssh_public_key_struct@Z" })
	SshLibrary.ssh_string publickey_to_string(SshLibrary.ssh_public_key key);

	/**
	 * Original signature :
	 * <code>ssh_message ssh_message_retrieve(ssh_session, uint32_t)</code><br>
	 * <i>native declaration : /usr/include/libssh/legacy.h:90</i>
	 */
	@Mangling({ "_Z20ssh_message_retrieveP18ssh_session_struct8uint32_t",
			"?ssh_message_retrieve@@YAPA18ssh_message_structPA18ssh_session_struct8uint32_t@Z" })
	...
	/**
	 * Original signature :
	 * <code>int string_fill(ssh_string, const void*, size_t)</code><br>
	...
	/**
	 * Original signature :
	 * <code>ssh_string string_from_char(const char*)</code><br>
	 * <i>native declaration : /usr/include/libssh/legacy.h:96</i><br>
	 * 
	 * @deprecated use the safer methods
	 *             {@link #string_from_char(java.lang.String)} and
	 *             {@link #string_from_char(com.sun.jna.Pointer)} instead
	 */
	 ...
	 *        * @param value The value to set. This is a generic pointer and
	 *        the<br>
	 *        datatype which is used should be set according to the<br>
	 *        type set.<br>
	 *        * @returns SSH_OK on success, SSH_ERROR on invalid option or
	 *        parameter.<br>
	 *        Original signature :
	 *        <code>int ssh_bind_options_set(ssh_bind, ssh_bind_options_e, const void*)</code><br>
	 ...
	 *        * @return 0 on success, < 0 on error.<br>
	 *        Original signature :
	 *        <code>int ssh_bind_listen(ssh_bind)</code><br>
	 ...
	 *        * @param[in] callbacks An already set up ssh_bind_callbacks
	 *        instance.<br>
	 *        * @param[in] userdata A pointer to private data to pass to the
	 *        callbacks.<br>
	 ...
	 * @endcode<br>
	 * 				Original signature :
	 *              <code>int ssh_bind_set_callbacks(ssh_bind, ssh_bind_callbacks, void*)</code><br>
	 ...
	 *        Original signature :
	 *        <code>void ssh_bind_set_blocking(ssh_bind, int)</code><br>
	 ...
	 *        Original signature :
	 *        <code>socket_t ssh_bind_get_fd(ssh_bind)</code><br>
	 ...
	 *        Original signature :
	 *        <code>void ssh_bind_set_fd(ssh_bind, socket_t)</code><br>
	 ...
	 *        * @param ssh_bind_o The ssh server bind to use.<br>
	 *        Original signature :
	 *        <code>void ssh_bind_fd_toaccept(ssh_bind)</code><br>
	 ...
	 *        * @param ssh_bind_o The ssh server bind to accept a
	 *        connection.<br>
	 * @param session A preallocated ssh session<br>
	 * @see ssh_new<br>
	 * @return SSH_OK when a connection is established<br>
	 *         Original signature :
	 *         <code>int ssh_bind_accept(ssh_bind, ssh_session)</code><br>
	 ...
	 *         Original signature :
	 *         <code>int ssh_handle_key_exchange(ssh_session)</code><br>
	 ...
	 * messages.c<br>
	 * Original signature :
	 * <code>int ssh_message_reply_default(ssh_message)</code><br>
	...
	/**
	 * Original signature :
	 * <code>char* ssh_message_auth_user(ssh_message)</code><br>
	...
	/**
	 * Original signature :
	 * <code>char* ssh_message_auth_password(ssh_message)</code><br>
	...
	/**
	 * Original signature :
	 * <code>ssh_public_key ssh_message_auth_publickey(ssh_message)</code><br>
	...
	/**
	 * Original signature :
	 * <code>ssh_publickey_state_e ssh_message_auth_publickey_state(ssh_message)</code><br>
	...
	/**
	 * Original signature :
	 * <code>int ssh_message_auth_reply_success(ssh_message, int)</code><br>
	...
	/**
	 * Original signature :
	 * <code>int ssh_message_auth_reply_pk_ok(ssh_message, ssh_string, ssh_string)</code><br>
	...
	/**
	 * Original signature :
	 * <code>int ssh_message_auth_reply_pk_ok_simple(ssh_message)</code><br>
	...
	/**
	 * Original signature :
	 * <code>int ssh_message_auth_set_methods(ssh_message, int)</code><br>
	...
	/**
	 * Original signature :
	 * <code>int ssh_message_service_reply_success(ssh_message)</code><br>
	...
	/**
	 * Original signature :
	 * <code>char* ssh_message_service_service(ssh_message)</code><br>
	...
	/**
	 * Original signature :
	 * <code>int ssh_message_global_request_reply_success(ssh_message, uint16_t)</code><br>
	...
	/**
	 * Original signature :
	 * <code>void ssh_set_message_callback(ssh_session, ssh_set_message_callback_arg1_ssh_bind_message_callback_callback, void*)</code><br>
	 * <i>native declaration : /usr/include/libssh/server.h:261</i>
	 */
	void ssh_set_message_callback(SshLibrary.ssh_session session,
			SshLibrary.ssh_set_message_callback_arg1_ssh_bind_message_callback_callback arg1, Pointer data);

	/**
	 * Original signature :
	 * <code>int ssh_execute_message_callbacks(ssh_session)</code><br>
	...
	/**
	 * Original signature :
	 * <code>char* ssh_message_channel_request_open_originator(ssh_message)</code><br>
	...
	/**
	 * Original signature :
	 * <code>int ssh_message_channel_request_open_originator_port(ssh_message)</code><br>
	...
	/**
	 * Original signature :
	 * <code>char* ssh_message_channel_request_open_destination(ssh_message)</code><br>
	...
	/**
	 * Original signature :
	 * <code>int ssh_message_channel_request_open_destination_port(ssh_message)</code><br>
	...
	/**
	 * Original signature :
	 * <code>ssh_channel ssh_message_channel_request_channel(ssh_message)</code><br>
	...
	/**
	 * Original signature :
	 * <code>char* ssh_message_channel_request_pty_term(ssh_message)</code><br>
	...
	/**
	 * Original signature :
	 * <code>int ssh_message_channel_request_pty_width(ssh_message)</code><br>
	...
	/**
	 * Original signature :
	 * <code>int ssh_message_channel_request_pty_height(ssh_message)</code><br>
	...
	/**
	 * Original signature :
	 * <code>int ssh_message_channel_request_pty_pxwidth(ssh_message)</code><br>
	...
	/**
	 * Original signature :
	 * <code>int ssh_message_channel_request_pty_pxheight(ssh_message)</code><br>
	...
	/**
	 * Original signature :
	 * <code>char* ssh_message_channel_request_env_name(ssh_message)</code><br>
	...
	/**
	 * Original signature :
	 * <code>char* ssh_message_channel_request_env_value(ssh_message)</code><br>
	...
	/**
	 * Original signature :
	 * <code>char* ssh_message_channel_request_command(ssh_message)</code><br>
	...
	/**
	 * Original signature :
	 * <code>char* ssh_message_channel_request_subsystem(ssh_message)</code><br>
	...
	/**
	 * Original signature :
	 * <code>char* ssh_message_global_request_address(ssh_message)</code><br>
	...
	/**
	 * Original signature :
	 * <code>int ssh_message_global_request_port(ssh_message)</code><br>
	...
	/**
	 * Original signature :
	 * <code>int ssh_channel_open_reverse_forward(ssh_channel, const char*, int, const char*, int)</code><br>
	 * <i>native declaration : /usr/include/libssh/server.h:289</i><br>
	 * 
	 * @deprecated use the safer methods
	 *             {@link #ssh_channel_open_reverse_forward(ssh.SshLibrary.ssh_channel, java.lang.String, int, java.lang.String, int)}
	 *             and
	 *             {@link #ssh_channel_open_reverse_forward(ssh.SshLibrary.ssh_channel, com.sun.jna.Pointer, int, com.sun.jna.Pointer, int)}
	 *             instead
	 */
	@Deprecated
	int ssh_channel_open_reverse_forward(SshLibrary.ssh_channel channel, Pointer remotehost, int remoteport, Pointer sourcehost,
			int localport);
	 ...
	 */
	int ssh_channel_open_reverse_forward(SshLibrary.ssh_channel channel, String remotehost, int remoteport, String sourcehost,
			int localport);

	/**
	 * Original signature :
	 * <code>int ssh_channel_request_send_exit_status(ssh_channel, int)</code><br>
	...
	/**
	 * Original signature :
	 * <code>int ssh_channel_request_send_exit_signal(ssh_channel, const char*, int, const char*, const char*)</code><br>
	 * <i>native declaration : /usr/include/libssh/server.h:294</i><br>
	 * 
	 * @deprecated use the safer methods
	 *             {@link #ssh_channel_request_send_exit_signal(ssh.SshLibrary.ssh_channel, java.lang.String, int, java.lang.String, java.lang.String)}
	 *             and
	 *             {@link #ssh_channel_request_send_exit_signal(ssh.SshLibrary.ssh_channel, com.sun.jna.Pointer, int, com.sun.jna.Pointer, com.sun.jna.Pointer)}
	 *             instead
	 */
	@Deprecated
	int ssh_channel_request_send_exit_signal(SshLibrary.ssh_channel channel, Pointer signum, int core, Pointer errmsg,
			Pointer lang);
	...
	/**
	 * Original signature :
	 * <code>int ssh_channel_write_stderr(ssh_channel, const void*, uint32_t)</code><br>
	...
	/**
	 * Original signature :
	 * <code>int channel_write_stderr(ssh_channel, const void*, uint32_t)</code><br>
